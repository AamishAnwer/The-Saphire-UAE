	...
	return (
		<div className="text-white flex flex-col  lg:flex-row gap-x-5 xl:gap-x-16 px-4 lg:px-14 py-10 md:py-16 lg:py-24">
			<Image
				...
				height={0}
				sizes="100vw"
				className="h-[500px] w-full max-lg:h-fit lg:min-w-[45%] min-w-[30%] rounded-xl object-contain shrink"
			/>
			<div className={`${imageToRight && "lg:-order-1"}`}>
			<div className="lg:my-7">
				<h1 className="text-left text-2xl md:text-3xl max-lg:mt-8 max-lg:text-center font-medium underline  underline-offset-8  decoration-2 ">
					{title}
				</h1>
