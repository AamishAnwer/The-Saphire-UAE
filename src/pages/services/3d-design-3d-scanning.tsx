...
import Main from "@/components/services/3ddesign/main";
import Body from "@/components/services/3ddesign/body";
	...
	return (
		<section className="w-full">
			<Hero
				type={"img"}
				src={"/3d/home.png"}
				heroText={"3D Design & 3D Scanning"}
			...
			<div className="md:hidden uppercase w-full h-72 md:h-96 bg-black text-white text-4xl md:text-6xl font-bold flex items-center justify-center relative overflow-hidden">
				...
				<span className="z-50 text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center w-full">3D Design & 3D Scanning</span>
			</div>
