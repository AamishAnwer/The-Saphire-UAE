			...
			<section className="overflow-hidden bg-gradient-to-r from-black to-[#2060AD] sm:grid sm:grid-cols-2">
				<div className="p-12 md:p-16 lg:px-20 lg:py-32">
					<div className="mx-auto max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
						...
						<p className="hidden text-xl text-gray-200 md:mt-6 md:block">
							Laser engraving is a technique that uses a focused laser beam to
							etch, mark, or cut materials such as wood, metal, glass, or
							plastic. The laser removes or alters the surface layer of the
							material to create precise and detailed designs, text, or
							patterns. This process is commonly employed in various industries,
							including signage, jewelry, and electronics, for its precision,
							speed, and versatility in producing intricate and permanent
				...
				<div className=" rounded-lg p-10">
					<img
						...
						src="https://d33609liqwio9r.cloudfront.net/2024-02-25T05%3A29%3A59.270Z-a4we1ztv7k9z.gif"
